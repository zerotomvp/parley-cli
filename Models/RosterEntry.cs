...
/// </summary>
public record RosterEntryWire(string Ts, string Role, string Sid, bool? Forced = null);
...
public record Participant(string Role, string Sid, string JoinedAt, int MessageCount, string LastActivity);
